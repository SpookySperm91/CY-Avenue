...
public class SystemAccountSearch : ISearch<SystemAccount, SystemAccountType?>, ISystemAccountSearch
{
    ...
    public List<SystemAccount?> SearchByFullName(string fullName, SystemAccountType? systemAccountType, out string message)
    {
        return Searches(null, fullName, null, systemAccountType, out message);
    }
    ...
    private List<SystemAccount?> Searches(int? id, string? fullName, string? email,
        SystemAccountType? systemAccountType, out string message)
    {
    ...
    private SystemAccount MapSystemAccount(MySqlDataReader reader)
    {
        return new SystemAccount
        {
            ...
            AccessType =  reader["access"].ToString(),
